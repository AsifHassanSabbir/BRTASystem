...
<body>
    ...
    <h3 style="font-family: Josefin Sans, sans-serif;
            color: #00000;text-align: center; padding-top: 11%;">Admin Login </h3>
    ...
    <div class="container">
        ...
        <div class="form_wrapper">
            <div class="form_container">
                ...
                <div>
                    <p style="text-decoration: none; font-family: Georgia">Not registered yet <a
                            href="adminregistration.php" style="color: Red; text-decoration: none;">
                            Register Here
                        </a></p>
                </div>
            </div>
